...
import me.postaddict.instagram.scraper.exception.InstagrammBadRequestException;
...
public class ErrorInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        switch (code) {
        	case 400:
        		throw new InstagrammBadRequestException("Bad request");
            case 401:
            ...
            default:
                throw new InstagramException("Response code is not equal 200. Something went wrong. Please report issue. (Code:"+code+")");
        }
    }
}
